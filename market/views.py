...
import json
from .models import Skin, Inventory, Transaction as MarketTransaction
from django.db import transaction
from accounts.models import Profile, Transaction as AccountTransaction, UserActivityLog
import logging
    ...
    if request.method == 'POST':
        try:
            with transaction.atomic():
                ...
                if profile.wallet_balance < skin.price:
                    return JsonResponse({
                        "success": False,
                ...
                profile.wallet_balance -= skin.price
                profile.save()
